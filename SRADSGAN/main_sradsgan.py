...
def parse_args():
    ...
    parser.add_argument('--model_name', type=str, default='SRADSGAN',
                        choices=['EDSR', 'SRGAN', 'DRCAN', 'DSSR', 'SRAGAN', 'NDSRGAN', 'AMSSRN', 'HAT', 'SRADSGAN'], help='The type of model')
    ...
    parser.add_argument('--num_threads', type=int, default=16, help='number of threads for data loader to use')
    parser.add_argument('--num_channels', type=int, default=3, help='The number of channels to super-resolve')
    parser.add_argument('--scale_factor', type=int, default=8, help='Size of scale factor')
...
def main():
    ...
    # test
    # 测试集整体测试
    # net.mfeNew_validate(epoch=100, modelpath='./Result/SRADSGAN/model/generator_param.pkl')

    # 测试集下不同类别逐个测试
    net.mfeNew_validateByClass(100, save_img=True, modelpath="./Result/SRADSGAN/model/generator_param.pkl")

    # # 单张图片推理
    # #GF2_LR.tif scale_factor=3 crop_size=test_crop_size=hr_height=hr_width=72
    # net.mfe_test_single(img_fn="./img/GF2_LR.tif", modelpath="/home/zju/mfe/SRADSGAN/Result/SRADSGAN_x3/model/generator_param.pkl")

    # #Sentinel2.tif scale_factor=9 crop_size=test_crop_size=hr_height=hr_width=216
    # net.mfe_test_single(img_fn="./img/Sentinel2.tif", modelpath="/home/zju/mfe/SRADSGAN/Result/SRADSGAN_x9/model/generator_param.pkl")
