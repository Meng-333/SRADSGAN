...
def parse_args():
    ...
    parser.add_argument('--model_name', type=str, default='AMSSRN',
...
def main():
    ...
    # test
    # 测试集整体测试
    # net.mfeNew_validate(epoch=100, modelpath='./Result/AMSSRN/model/generator_param.pkl')

    # 测试集下不同类别逐个测试
    net.mfeNew_validateByClass(100, save_img=True, modelpath="./Result/AMSSRN/model/generator_param.pkl")

    # # 单张图片推理
    # #GF2_LR.tif scale_factor=3 crop_size=test_crop_size=hr_height=hr_width=72
    # net.mfe_test_single(img_fn="./img/GF2_LR.tif", modelpath="/home/zju/mfe/SRADSGAN/Result/AMSSRN_x3/model/generator_param.pkl")

    # #Sentinel2.tif scale_factor=9 crop_size=test_crop_size=hr_height=hr_width=216
    # net.mfe_test_single(img_fn="./img/Sentinel2.tif", modelpath="/home/zju/mfe/SRADSGAN/Result/AMSSRN_x9/model/generator_param.pkl")
