...
def resize_multiple(img, sizes=(72, 216), resample=Image.BICUBIC, lmdb_save=False):
...
def prepare(img_path, out_path, n_worker, sizes=(72, 216), resample=Image.BICUBIC, lmdb_save=False):
...
#                         default='./Train')
    ...
    parser.add_argument('--size', type=str, default='72, 216')
